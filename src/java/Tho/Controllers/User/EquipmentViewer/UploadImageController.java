        ...
        try {
            ...
            if (isMultiPart) {
                ...
                if (savedItem != null) {
                    ...
                    String realPath = getServletContext().getRealPath("/") + "src\\img\\[Equipment]" + code + "." + extension;
                    File savedFile = new File(realPath);
                    savedItem.write(savedFile);
                    if (new EquipmentDAO().updateImage(code, "src/img/[Equipment]" + code + "." + extension)) {
            ...
            log("Error at EquipmentViewer.UploadImageController", e);
        } finally {
